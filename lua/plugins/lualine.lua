return {
    ...
    config = function()
        ...
        ins('lualine_c', { function() return '%=' end }) -- mid section
        ins('lualine_c', {
            function()
        ...
        ins('lualine_x',
            { 'o:encoding', fmt = string.upper, cond = hide_in_width, color = { fg = colors.green, gui = 'bold' } })
        ins('lualine_x',
            { 'fileformat', fmt = string.upper, icons_enabled = false, color = { fg = colors.green, gui = 'bold' } })
        ins('lualine_x',
            { 'branch', icon = '', color = { fg = colors.violet, gui = 'bold' }, cond = check_git_workspace })
        ins('lualine_x',
            {
                'diff',
        ...
        ins('lualine_x', { function() return '▊' end, color = { fg = colors.blue }, padding = { left = 1 } })
